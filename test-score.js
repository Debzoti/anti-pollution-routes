...
async function runTests() {
  try {
    ...
    const routes = await fetchRoutes(22.5726, 88.3639, 22.6000, 88.4000);
    ...
    if (routes.length > 0) {
      ...
      console.log('PES Result:', { routeId: pesResult.routeId, pes: pesResult.pes, polylinePoints: pesResult.polyline.length });
    }
  } catch(e) {
